package com.daqsoft.customview.progress;
 ...
 * 一般50dp宽高
 * 自定义属性
 * progress_start_degree 开始倒计时的位置
 * progress_text_color   圆形中间字体颜色
 * style 样式 solid 填充 line线条
 * progress_background_color solid时:填充背景色 line时:线条背景色
 * progress_start_color 开始颜色
 * progress_end_color   结束颜色
 * drawBackgroundOutsideProgress 圆形倒计时边线是否跟随消失
 * progress_stroke_width 边线的宽度 一般4dp line样式1dp
 *
 */
public class CircleProgressBar extends View {
    ...
    private void initFromAttributes(Context context, AttributeSet attrs) {
        ...
        mProgressTextSize = a.getDimensionPixelSize(R.styleable.CircleProgressBar_progress_text_size, SizeUtils.dp2px(DEFAULT_PROGRESS_TEXT_SIZE));
        mProgressStrokeWidth = a.getDimensionPixelSize(R.styleable.CircleProgressBar_progress_stroke_width, SizeUtils.dp2px(DEFAULT_PROGRESS_STROKE_WIDTH));
