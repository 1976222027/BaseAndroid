...
public abstract class BaseSupportActivity<P extends IBasePresenter> extends AppCompatActivity
        implements ISupportActivity,IBaseView {
     ...
     * {@link SupportFragment#startWithPopTo(ISupportFragment, Class, boolean)}.
     *
